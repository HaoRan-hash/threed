...
if __name__ == '__main__':
    ...
    log_dir = 'partseg/pointnet2_partseg_rotation.log'
    ...
    pointnet2 = Pointnet2(50).to(device)
    ...
    epochs = 200
    show_gap = 1
    save_path = 'partseg/pointnet2_partseg_rotation.pth'
    ...
    voting_test(test_dataloader, pointnet2, loss_fn, device, save_path, log_dir, 10)
