...
class Memory(nn.Module):
    ...
    def forward(self, features, coarse_pred, gts=None):
        ...
        reve_features = torch.bmm(coarse_pred, memory_features)
...
if __name__ == '__main__':
    ...
    log_dir = 'seg/logs/memorynet_seg_x3x2_contrast_no_attention.log'
    ...
    epochs = 100
    show_gap = 1
    save_path = 'seg/checkpoints/memorynet_seg_x3x2_contrast_no_attention.pth'
