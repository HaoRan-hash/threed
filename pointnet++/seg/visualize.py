...
save_dir = Path('/mnt/Disk16T/chenhr/threed/pointnet++/seg/vis_results/baseline')
gt_dir = Path('/mnt/Disk16T/chenhr/threed/pointnet++/seg/vis_results/gt')
...
if __name__ == '__main__':
    ...
    # model = Memorynet(13).to(device)   # memory版
    
    model_path = 'seg/checkpoints/pointnet2_seg_amp.pth'
    # model_path = 'seg/checkpoints/memorynet_seg_x3x2_contrast_1tao.pth'   # memory版
