...
if __name__ == '__main__':
    ...
    log_dir = 'seg/pointnet2_seg_amp_2.log'
    ...
    val_aug = Compose([PointCloudFloorCentering(),
                       ColorNormalize()])
    val_dataset = S3dis('/mnt/Disk16T/chenhr/threed_data/data/processed_s3dis', split='val', loop=1, npoints=None, transforms=val_aug)
    ...
    pointnet2 = Pointnet2(13).to(device)
    ...
    epochs = 100
    show_gap = 1
    save_path = 'seg/pointnet2_seg_amp_2.pth'
    ...
    test_dataset = S3dis('/mnt/Disk16T/chenhr/threed_data/data/processed_s3dis', split='test', loop=1)
