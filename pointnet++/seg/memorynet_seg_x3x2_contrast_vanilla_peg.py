...
from utils_func import ball_query_cuda2, knn_query_cuda2, index_points, index_gts, SemanticAwareAttention, PEGenerator_vanilla
...
class Memorynet(nn.Module):
    def __init__(self, num_class):
        ...
        self.pe_gen1 = PEGenerator_vanilla(256)
        ...
        self.pe_gen2 = PEGenerator_vanilla(256)
...
if __name__ == '__main__':
    ...
    log_dir = 'seg/logs/memorynet_seg_x3x2_contrast_vanilla_peg.log'
    ...
    epochs = 100
    show_gap = 1
    save_path = 'seg/checkpoints/memorynet_seg_x3x2_contrast_vanilla_peg.pth'
