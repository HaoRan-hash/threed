...
save_dir = Path('/mnt/Disk16T/chenhr/threed/pointnet++/scannet/vis_results/memory')
...
if __name__ == '__main__':
    ...
    test_entire_room(test_dataloader, test_aug, pointnet2, device, model_path, rank, save_gt=True)
