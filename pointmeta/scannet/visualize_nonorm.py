...
save_dir = Path('/mnt/Disk16T/chenhr/threed/pointmeta/scannet/vis_results/baseline')
...
if __name__ == '__main__':
    ...
    model_path = 'scannet/checkpoints/pointmeta_scannet_nonorm.pth'
    ...
    test_entire_room(test_dataloader, test_aug, pointmeta, device, model_path, rank)
