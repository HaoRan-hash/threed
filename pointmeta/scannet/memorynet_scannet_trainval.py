...
# save_dir = Path('/mnt/Disk16T/chenhr/threed/pointmeta/scannet/save_zips/memory_novote')
...
save_dir = Path('/mnt/Disk16T/chenhr/threed/pointmeta/scannet/save_zips/memory')
...
if __name__ == '__main__':
    ...
    #     if rank == 0:
    #         torch.save({'epoch': i,
    #                     'model_state_dict': pointmeta.state_dict(),
    ...
    # test_entire_room(test_dataloader, test_aug, pointmeta, device, save_path, rank)
    voting_test(test_dataloader, test_aug, pointmeta, device, save_path, rank)
