...
from memorynet_seg_v1_x3x2_poly_pe_contrast import Memorynet
...
save_dir = Path('/mnt/Disk16T/chenhr/threed/pointnext/seg/vis_results/baseline')
gt_dir = Path('/mnt/Disk16T/chenhr/threed/pointnext/seg/vis_results/gt')
...
if __name__ == '__main__':
    ...
    # model = Memorynet(13, 4, 32, [3, 6, 3, 3]).to(device)   # memory版
    
    model_path = 'seg/checkpoints/pointnext_seg_amp.pth'
    # model_path = 'seg/checkpoints/memorynet_seg_v1_x3x2_poly_pe_contrast_001tao_2.pth'   # memory版
