...
# params = {
#     'coarse_seg_loss_weight1': 0.1,
#     'coarse_seg_loss_weight2': 0.1
# }
...
if __name__ == '__main__':
    ...
    log_dir = 'seg/memorynet_seg_v1_x3x2_poly_pe_contrast_area4.log'
    ...
    train_aug = Compose([ColorContrast(p=0.2),
                         ...
                         ColorDrop(p=0.2),
                         ColorNormalize()])
    train_dataset = S3dis('/home/lindi/chenhr/threed/data/processed_s3dis', split='train', loop=30, npoints=24000, transforms=train_aug, test_area=4)
    val_aug = Compose([PointCloudFloorCentering(),
                        ColorNormalize()])
    val_dataset = S3dis('/home/lindi/chenhr/threed/data/processed_s3dis', split='val', loop=1, npoints=None, transforms=val_aug, test_area=4)
    ...
    epochs = 100
    show_gap = 1
    save_path = 'seg/memorynet_seg_v1_x3x2_poly_pe_contrast_area4.pth'
    ...
    test_dataset = S3dis('/home/lindi/chenhr/threed/data/processed_s3dis', split='test', loop=1, test_area=4)
    test_dataloader = DataLoader(test_dataset, batch_size=1, shuffle=False, num_workers=8)
    # test_entire_room(test_dataloader, test_aug, memorynet, loss_fn, device, save_path, log_dir)
    multi_scale_test(test_dataloader, test_aug, memorynet, loss_fn, device, save_path, log_dir)
