...
if __name__ == '__main__':
    ...
    log_dir = 'seg/pointnext_seg_amp.log'
    ...
    pointnext = PointNeXt(13, 4, 32, [3, 6, 3, 3]).to(device)
    ...
    epochs = 100
    show_gap = 1
    save_path = 'seg/pointnext_seg_amp.pth'
    ...
    test_entire_room(test_dataloader, test_aug, pointnext, loss_fn, device, save_path, log_dir)
