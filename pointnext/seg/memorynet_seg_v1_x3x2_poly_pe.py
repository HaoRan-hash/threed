...
from utils_func import ball_query_cuda2, knn_query_cuda2, index_points, index_gts, RegionAwareAttention, PEGenerator
...
class Memorynet(nn.Module):
    ...
    def forward(self, pos, x, y=None, epoch_ratio=None):
        ...
        x3 = self.memory1(x3, coarse_pred1)
        ...
        x2 = self.memory2(x2, coarse_pred2)
...
if __name__ == '__main__':
    ...
    log_dir = 'seg/memorynet_seg_v1_x3x2_poly_pe_v2.log'
    ...
    epochs = 100
    show_gap = 1
    save_path = 'seg/memorynet_seg_v1_x3x2_poly_pe_v2.pth'
