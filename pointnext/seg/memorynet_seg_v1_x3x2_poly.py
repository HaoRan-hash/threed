...
class Memory(nn.Module):
    ...
    def forward(self, features, coarse_pred, gts=None):
        ...
        reve_features, attn_map = self.attention(F.normalize(features, dim=-1), memory_features, memory_features, coarse_pred, need_weights=True)
...
class Memorynet(nn.Module):
    ...
    def forward(self, pos, x, y=None, epoch_ratio=None):
        ...
        x2, attn_map = self.memory2(x2, coarse_pred2)
        ...
        return y_pred, coarse_seg_loss, attn_map, coarse_pred2
...
def train_loop(dataloader, model, loss_fn, metric_fn, optimizer, device, 
    ...
    for i, (pos, x, y) in enumerate(pbar):
        ...
        with torch.cuda.amp.autocast():
            y_pred, coarse_seg_loss = model(pos, x, y, cur_epoch/total_epoch)
...
if __name__ == '__main__':
    ...
    log_dir = 'seg/memorynet_seg_v1_x3x2_poly_v2.log'
    ...
    epochs = 100
    show_gap = 1
    save_path = 'seg/memorynet_seg_v1_x3x2_poly_v2.pth'
