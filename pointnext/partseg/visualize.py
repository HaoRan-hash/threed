...
save_dir = Path('/mnt/Disk16T/chenhr/threed/pointnext/partseg/vis_results/baseline')
gt_dir = Path('/mnt/Disk16T/chenhr/threed/pointnext/partseg/vis_results/gt')
...
if __name__ == '__main__':
    ...
    model_path = 'partseg/checkpoints/pointnext_partseg.pth'
