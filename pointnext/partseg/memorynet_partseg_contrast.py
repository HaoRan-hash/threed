...
class Memorynet(nn.Module):
    ...
    def forward(self, pos, normal, object_labels, y=None, epoch_ratio=None):
        ...
        x2, contrast_loss = self.memory2(x2, coarse_pred2, mask_float, y2)
...
if __name__ == '__main__':
    ...
    log_dir = 'partseg/memorynet_partseg_contrast_adam.log'
    ...
    optimizer = torch.optim.Adam(memorynet.parameters(), lr=1e-3)
    lr_scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, [140, 180], 0.1)

    epochs = 200
    show_gap = 1
    save_path = 'partseg/memorynet_partseg_contrast_adam.pth'
