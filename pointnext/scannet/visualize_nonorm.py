...
from model_nonorm import PointNeXt
...
save_dir = Path('/mnt/Disk16T/chenhr/threed/pointnext/scannet/vis_results/baseline')
gt_dir = Path('/mnt/Disk16T/chenhr/threed/pointnext/scannet/vis_results/gt')
...
if __name__ == '__main__':
    ...
    model_path = 'scannet/checkpoints/pointnext_scannet_nonorm.pth'
    ...
    test_entire_room(test_dataloader, test_aug, pointnext, device, model_path, rank)
