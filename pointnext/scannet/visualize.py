...
save_dir = Path('/mnt/Disk16T/chenhr/threed/pointnext/scannet/vis_results/memory')
...
if __name__ == '__main__':
    ...
    test_entire_room(test_dataloader, test_aug, pointnext, device, model_path, rank, save_gt=True)
